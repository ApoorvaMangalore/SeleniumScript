...
public class SearchitemCss {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		  ...
		  WebElement searchtextbox = driver.findElement(By.cssSelector( "input.search-box-text.ui-autocomplete-input"));
		 ...
		 * cssSelector("input[class='search-box-text ui-autocomplete-input']")).click();
		 * 
